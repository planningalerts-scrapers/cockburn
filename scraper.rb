...
starting_url = 'http://masterview.cockburn.wa.gov.au/MasterViewUI/modules/ApplicationMaster/default.aspx?page=found&1=thisweek&4a=DevelopA&6=F'
comment_url = 'mailto:masterplan@cockburn.wa.gov.au'
...
def scrape_table(doc, comment_url)
  ...
  doc.search('table tbody tr').each do |tr|
    ...
    info_url = 'http://masterview.cockburn.wa.gov.au/MasterViewUI/modules/ApplicationMaster/' + tds[0].at('a')['href'].strip
    ...
    record = {
      ...
      'address' => clean_whitespace(info_page.at('div#lblProp').at('a').inner_text.strip) + ", WA",
